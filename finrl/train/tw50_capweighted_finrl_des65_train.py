"""Train 5 SB3 agents with CapAnchoredPortfolioEnv:
  features = FinRL 8 indicators + DES (from all_65) + 252-day cov
  TIMESTEPS = 60000
...
RESULTS_DIR = str(FINRL_ROOT / "tw50_capweighted_finrl_des65_results")
...
print("=== Loading tw50_capweighted_finrl_des65_train.pkl ===")
